...
| [`xllm-npu-op-migration-prompts.md`](xllm-npu-op-migration-prompts.md) | NPU 算子迁移、torch_npu/Triton-Ascend/AscendC/ATB 接入、kernel-pilot 准入 |
...
5. 每个 prompt 结尾都要要求沉淀经验：run ledger、case study、reference、
